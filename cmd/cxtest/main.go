...
func runTestCases(t *runner.TestRunner) {
	...
	t.Run("test-slices-insert-out-of-range-b.cx", runner.CxRuntimeInvalidCast, "Test insert with index < 0")
	t.Run("test-slices-remove-out-of-range-a.cx", runner.CxRuntimeInvalidCast, "Test remove with index < 0")
